disp('SIMULATED ANNEALING FOR MASS COMM & POLITICAL SCIENCE')


% SIMULATED ANNEALING FOR COURSE TIMETABLING
% LAW AND MASS COMMUNICATION DEPARTMENT && POLITICAL SCIENCE
% [Tmax]=sa_main_comm(T)
T=input('Enter the Maximum temperature: ');
tic
Tmax=T;
warning off
disp('SIMULATED ANNEALING FOR COURSE TIMETABLING OF LAW AND MASS COMMUNICATION DEPARTMENT && POLITICAL SCIENCE');disp(' ');

disp('            ');
disp('            ');
disp('            ');
%get initial solution
sa_initial_mass_comm;
